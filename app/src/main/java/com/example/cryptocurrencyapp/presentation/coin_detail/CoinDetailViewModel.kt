...
import com.example.cryptocurrencyapp.domain.use_case.get_coin.CoinDetailState
import com.example.cryptocurrencyapp.domain.use_case.get_coin.GetCoinUseCase
import com.example.cryptocurrencyapp.domain.use_case.get_coins.CoinListState
...
class CoinDetailViewModel @Inject constructor(
    ...
    init {
        savedStateHandle.get<String>(Constant.PARA_USER_COIN_ID)?.let { coinId ->
